...
- [x] **Donation** (`donation`) | `class-gf-field-donation.php` - *Deprecated in GF 2.9*
- [x] **Repeater** (`repeater`) | `class-gf-field-repeater.php` - *Beta/Ignored*
- [x] **Submit Button** (`submit`) | `class-gf-field-submit.php` - *Not a data field*
