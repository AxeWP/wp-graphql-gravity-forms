<?php
/**
 * GraphQL Field - PostTitleFieldValueProperty
 * Values for an individual PostTitle field.
 *
...
/**
 * Class - PostTitleFieldValueProperty
 */
class PostTitleFieldValueProperty extends AbstractValueProperty {
	/**
	...
	public function get_type_description() : string {
		return __( 'PostTitle field value.', 'wp-graphql-gravity-forms' );
	}
