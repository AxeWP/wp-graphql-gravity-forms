<?php
/**
 * GraphQL Field - PostCategoryFieldValueProperty
 * Values for an individual PostCategory field.
 *
...
/**
 * Class - PostCategoryFieldValueProperty
 */
class PostCategoryFieldValueProperty extends AbstractValueProperty {
	/**
	...
	public function get_type_description() : string {
		return __( 'PostCategory field value.', 'wp-graphql-gravity-forms' );
	}
