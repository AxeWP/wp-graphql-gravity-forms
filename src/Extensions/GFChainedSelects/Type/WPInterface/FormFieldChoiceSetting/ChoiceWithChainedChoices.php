 ...
 *
 * @package  WPGraphQL\GF\Extensions\GFChainedSelects\Type\WPInterface\FormFieldChoiceSetting
 * @since  @todo
 */

namespace WPGraphQL\GF\Extensions\GFChainedSelects\Type\WPInterface\FormFieldChoiceSetting;
 ...
 */
class ChoiceWithChainedChoices extends AbstractFormFieldChoiceSetting {
	/**
