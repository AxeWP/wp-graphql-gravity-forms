...
use WPGraphQL\GF\Type\WPObject\FormField\FieldProperty\ValueProperty\SelectFieldValueProperty;

/**
 * Class - SelectFieldValue
 */
class SelectFieldValue extends AbstractObject implements FieldValue {
	/**
	 * Type registered in WPGraphQL.
	 *
	 * @var string
	 */
	public static string $type = 'SelectFieldValue';
	...
	public static function get( array $entry, GF_Field $field ) : array {
		return [ 'value' => SelectFieldValueProperty::get( $entry, $field ) ];
	}
}
