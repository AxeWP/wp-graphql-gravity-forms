...
class FormFieldChoiceRegistry {
	...
	public static function get_interfaces( array $settings ) : array {
		// Every Choice is a FormFieldChoice.
		$interfaces = [
			FormFieldChoice::$type,
		];
	...
	/**
	 * Gets the fields to register to the FormFieldChoice object.
	 *
	...
	public static function get_fields( string $choice_name, GF_Field $field, array $settings, array $interfaces ) : array {
		$fields = FormFieldChoice::get_fields();
