...
class TypeRegistry {
	...
	public static function interfaces() : array {
		$classes_to_register = [
			...
			WPInterface\FormFieldChoice::class,
			WPInterface\FormFieldInput::class,
	...
	public static function form_field_settings() : array {
		...
		$classes_to_register = [
			'add_icon_url_setting'               => WPInterface\FormFieldSetting\FieldWithAddIconUrl::class,
			'address_setting'                    => WPInterface\FormFieldSetting\FieldWithAddress::class,
			'admin_label_setting'                => WPInterface\FormFieldSetting\FieldWithAdminLabel::class,
			'autocomplete_setting'               => WPInterface\FormFieldSetting\FieldWithAutocomplete::class,
			'base_price_setting'                 => WPInterface\FormFieldSetting\FieldWithBasePrice::class,
			'calculation_setting'                => WPInterface\FormFieldSetting\FieldWithCalculation::class,
			'captcha_badge_setting'              => WPInterface\FormFieldSetting\FieldWithCaptchaBadge::class,
			'captcha_bg_setting'                 => WPInterface\FormFieldSetting\FieldWithCaptchaBg::class,
			'captcha_fg_setting'                 => WPInterface\FormFieldSetting\FieldWithCaptchaFg::class,
			'captcha_language_setting'           => WPInterface\FormFieldSetting\FieldWithCaptchaLanguage::class,
			'captcha_size_setting'               => WPInterface\FormFieldSetting\FieldWithCaptchaSize::class,
			'captcha_theme_setting'              => WPInterface\FormFieldSetting\FieldWithCaptchaTheme::class,
			'captcha_type_setting'               => WPInterface\FormFieldSetting\FieldWithCaptchaType::class,
			'checkbox_label_setting'             => WPInterface\FormFieldSetting\FieldWithCheckboxLabel::class,
			'choices_setting'                    => WPInterface\FormFieldSetting\FieldWithChoices::class,
			'columns_setting'                    => WPInterface\FormFieldSetting\FieldWithColumns::class,
			'conditional_logic_setting'          => WPInterface\FormFieldSetting\FieldWithConditionalLogic::class,
			'content_setting'                    => WPInterface\FormFieldSetting\FieldWithContent::class,
			'copy_values_option'                 => WPInterface\FormFieldSetting\FieldWithCopyValuesOption::class,
			'credit_card_setting'                => WPInterface\FormFieldSetting\FieldWithCreditCard::class,
			'css_class_setting'                  => WPInterface\FormFieldSetting\FieldWithCssClass::class,
			'date_format_setting'                => WPInterface\FormFieldSetting\FieldWithDateFormat::class,
			'date_input_type_setting'            => WPInterface\FormFieldSetting\FieldWithDateInputType::class,
			'default_value_setting'              => WPInterface\FormFieldSetting\FieldWithDefaultValue::class,
			'delete_icon_url_setting'            => WPInterface\FormFieldSetting\FieldWithDeleteIconUrl::class,
			'description_setting'                => WPInterface\FormFieldSetting\FieldWithDescription::class,
			'disable_margins_setting'            => WPInterface\FormFieldSetting\FieldWithDisableMargins::class,
			'disable_quantity_setting'           => WPInterface\FormFieldSetting\FieldWithDisableQuantity::class,
			'duplicate_setting'                  => WPInterface\FormFieldSetting\FieldWithDuplicate::class,
			'email_confirm_setting'              => WPInterface\FormFieldSetting\FieldWithEmailConfirm::class,
			'enable_enhanced_ui_setting'         => WPInterface\FormFieldSetting\FieldWithEnableEnhancedUI::class,
			'error_message_setting'              => WPInterface\FormFieldSetting\FieldWithErrorMessage::class,
			'file_extensions_setting'            => WPInterface\FormFieldSetting\FieldWithFileExtensions::class,
			'file_size_setting'                  => WPInterface\FormFieldSetting\FieldWithFileSize::class,
			'force_ssl_field_setting'            => WPInterface\FormFieldSetting\FieldWithForceSSLField::class,
			'input_mask_setting'                 => WPInterface\FormFieldSetting\FieldWithInputMask::class,
			'label_setting'                      => WPInterface\FormFieldSetting\FieldWithLabel::class,
			'label_placement_setting'            => WPInterface\FormFieldSetting\FieldWithLabelPlacement::class,
			'maxlen_setting'                     => WPInterface\FormFieldSetting\FieldWithMaxlen::class,
			'maxrows_setting'                    => WPInterface\FormFieldSetting\FieldWithMaxrows::class,
			'multiple_files_setting'             => WPInterface\FormFieldSetting\FieldWithMultipleFiles::class,
			'name_setting'                       => WPInterface\FormFieldSetting\FieldWithName::class,
			'next_button_setting'                => WPInterface\FormFieldSetting\FieldWithNextButton::class,
			'number_format_setting'              => WPInterface\FormFieldSetting\FieldWithNumberFormat::class,
			'other_choice_setting'               => WPInterface\FormFieldSetting\FieldWithOtherChoice::class,
			'password_setting'                   => WPInterface\FormFieldSetting\FieldWithPassword::class,
			'password_field_setting'             => WPInterface\FormFieldSetting\FieldWithPasswordField::class,
			'password_strength_setting'          => WPInterface\FormFieldSetting\FieldWithPasswordStrength::class,
			'password_visibility_setting'        => WPInterface\FormFieldSetting\FieldWithPasswordVisibility::class,
			'phone_format_setting'               => WPInterface\FormFieldSetting\FieldWithPhoneFormat::class,
			'placeholder_setting'                => WPInterface\FormFieldSetting\FieldWithPlaceholder::class,
			'post_category_checkbox_setting'     => WPInterface\FormFieldSetting\FieldWithPostCategoryCheckbox::class,
			'post_category_initial_item_setting' => WPInterface\FormFieldSetting\FieldWithPostCategoryInitialItem::class,
			'post_custom_field_setting'          => WPInterface\FormFieldSetting\FieldWithPostCustomField::class,
			'post_image_setting'                 => WPInterface\FormFieldSetting\FieldWithPostImage::class,
			'post_image_featured_image'          => WPInterface\FormFieldSetting\FieldWithPostImageFeaturedImage::class,
			'prepopulate_field_setting'          => WPInterface\FormFieldSetting\FieldWithPrepopulateField::class,
			'previous_button_setting'            => WPInterface\FormFieldSetting\FieldWithPreviousButton::class,
			'product_field_setting'              => WPInterface\FormFieldSetting\FieldWithProductField::class,
			'range_setting'                      => WPInterface\FormFieldSetting\FieldWithRange::class,
			'rich_text_editor_setting'           => WPInterface\FormFieldSetting\FieldWithRichTextEditor::class,
			'rules_setting'                      => WPInterface\FormFieldSetting\FieldWithRules::class,
			'select_all_choices_setting'         => WPInterface\FormFieldSetting\FieldWithSelectAllChoices::class,
			'size_setting'                       => WPInterface\FormFieldSetting\FieldWithSize::class,
			'sub_label_placement_setting'        => WPInterface\FormFieldSetting\FieldWithSubLabelPlacement::class,
			'time_format_setting'                => WPInterface\FormFieldSetting\FieldWithTimeFormat::class,
		];
	...
	public static function form_field_setting_inputs() : array {
		// Key-value pairs of settings and their corresponding class name.
		$classes_to_register = [
			'address_setting'            => WPInterface\FormFieldInputSetting\InputWithAddress::class,
			'date_format_setting'        => WPInterface\FormFieldInputSetting\InputWithDateFormat::class,
			'email_confirm_setting'      => WPInterface\FormFieldInputSetting\InputWithEmailConfirm::class,
			'name_setting'               => WPInterface\FormFieldInputSetting\InputWithName::class,
			'password_setting'           => WPInterface\FormFieldInputSetting\InputWithPassword::class,
			'select_all_choices_setting' => WPInterface\FormFieldInputSetting\InputWithSelectAllChoices::class,
			'time_format_setting'        => WPInterface\FormFieldInputSetting\InputWithTimeFormat::class,
		];
	...
	public static function form_field_setting_choices() : array {
		// Key-value pairs of settings and their corresponding class name.
		$classes_to_register = [
			'choices_setting'      => WPInterface\FormFieldChoiceSetting\ChoiceWithChoices::class,
			'columns_setting'      => WPInterface\FormFieldChoiceSetting\ChoiceWithColumns::class,
			'name_setting'         => WPInterface\FormFieldChoiceSetting\ChoiceWithName::class,
			'other_choice_setting' => WPInterface\FormFieldChoiceSetting\ChoiceWithOtherChoice::class,
		];
