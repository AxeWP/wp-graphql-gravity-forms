...
class TypeRegistry {
	...
	public static function objects() : array {
		$classes_to_register = [
			...
			WPObject\FormField\FieldDataPolicy::class,
	...
	public static function form_field_settings() : array {
		...
		$classes_to_register = [
			...
			'address_setting'                    => WPInterface\FieldSetting\FieldWithAddressData::class,
			...
			'base_price_setting'                 => WPInterface\FieldSetting\FieldWithPrice::class,
			...
			'disable_margins_setting'            => WPInterface\FieldSetting\FieldWithMargins::class,
			...
			'force_ssl_field_setting'            => WPInterface\FieldSetting\FieldWithForcedSSL::class,
			...
			'name_setting'                       => WPInterface\FieldSetting\FieldWithNameInput::class,
			...
			'password_field_setting'             => WPInterface\FieldSetting\FieldWithPasswordInput::class,
			...
			'post_category_initial_item_setting' => WPInterface\FieldSetting\FieldWithPostCategoryPlaceholder::class,
			'post_custom_field_setting'          => WPInterface\FieldSetting\FieldWithPostMeta::class,
			...
			'prepopulate_field_setting'          => WPInterface\FieldSetting\FieldWithPrepopulate::class,
			'previous_button_setting'            => WPInterface\FieldSetting\FieldWithPreviousButton::class,
			'product_field_setting'              => WPInterface\FieldSetting\FieldWithProduct::class,
			...
			'single_product_inputs'              => WPInterface\FieldSetting\FieldWithSingleProductInput::class,
	...
	public static function form_field_setting_inputs() : array {
		...
		$classes_to_register = [
			...
			'email_confirm_setting'      => WPInterface\FieldInputSetting\InputWithEmailConfirm::class,
