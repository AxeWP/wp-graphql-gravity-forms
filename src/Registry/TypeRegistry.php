...
class TypeRegistry {
	...
	public static function form_field_settings() : array {
		...
		$classes_to_register = [
			...
			'duplicate_setting'                  => WPInterface\FieldSetting\FieldWithDuplicate::class,
			'email_confirm_setting'              => WPInterface\FieldSetting\FieldWithEmailConfirm::class,
			'enable_enhanced_ui_setting'         => WPInterface\FieldSetting\FieldWithEnableEnhancedUI::class,
			...
			'maxlen_setting'                     => WPInterface\FieldSetting\FieldWithMaxlen::class,
