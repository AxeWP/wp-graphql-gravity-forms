...
use WPGraphQL\GF\Type\WPInterface\FormFieldInput;
use WPGraphQL\GF\Utils\Utils;

/**
 * Class - FormFieldInputRegistry
 */
class FormFieldInputRegistry {
	...
	public static function register( GF_Field $field, $settings ) : void {
		...
		$input_name = Utils::get_safe_form_field_type_name( $input_name );
	...
	public static function get_interfaces( array $settings ) : array {
		// Every Input is a FormFieldInput.
		$interfaces = [
			FormFieldInput::$type,
		];
	...
	/**
	 * Gets the fields to register to the FormFieldInput object.
	 *
	...
	public static function get_fields( string $input_name, GF_Field $field, array $settings, array $interfaces ) : array {
		$fields = FormFieldInput::get_fields();
