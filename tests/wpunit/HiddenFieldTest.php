 ...
 */
class HiddenFieldTest extends GFGraphQLTestCase {
	private $fields = [];
	private $form_id;
	private $entry_id;
	private $draft_token;
	...
	public function setUp(): void {
		...
		$this->property_helper = $this->tester->getHiddenFieldHelper();
	...
	/**
	 * Tests HiddenField properties and values.
	 */
	...
	/**
	 * Test submitting HiddenField asa draft entry with submitGravityFormsForm.
	 */
	...
	/**
	 * Test submitting HiddenField with submitGravityFormsForm.
	 */
	...
	/**
	 * Test submitting HiddenField with updateDraftEntryHiddenFieldValue.
	 */
	public function testUpdateDraftEntryFieldValue() : void {
		...
		// Test draft entry.
		$query = '
			mutation updateDraftEntryHiddenFieldValue( $fieldId: Int!, $resumeToken: String!, $value: String! ){
				updateDraftEntryHiddenFieldValue(input: {clientMutationId: "abc123", fieldId: $fieldId, resumeToken: $resumeToken, value: $value}) {
					errors {
						id
						message
					}
