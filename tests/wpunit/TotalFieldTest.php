 ...
 */
class TotalFieldTest extends FormFieldTestCase implements FormFieldTestCaseInterface {
	...
	public function field_value_input() {
		return $this->fields[0]->basePrice;
	}
