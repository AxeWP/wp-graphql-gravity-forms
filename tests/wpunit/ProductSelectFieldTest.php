...
/**
 * Class -ProductSelectFieldTest
 */
class ProductSelectFieldTest extends FormFieldTestCase implements FormFieldTestCaseInterface {
	/**
	...
	public function check_saved_values( $actual_entry, $form ): void {
		$this->assertEquals( $this->field_value_input . '|5', $actual_entry[ $form['fields'][0]->id ], 'Submit mutation entry value not equal' );
	}
}
