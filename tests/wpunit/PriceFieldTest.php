 ...
 */
class PriceFieldTest extends FormFieldTestCase implements FormFieldTestCaseInterface {
	/**
	...
	public function field_helper() {
		return $this->tester->getPropertyHelper( 'PriceField' );
	}
	...
	public function field_value() {
		return (string) $this->property_helper->basePrice();
	}
