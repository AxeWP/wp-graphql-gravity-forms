...
/**
 * Class -PostCustomFieldTest.
 */
class PostCustomFieldTest extends FormFieldTestCase implements FormFieldTestCaseInterface {
	/**
	...
	public function field_helper() {
		return $this->tester->getPropertyHelper( 'PostCustomField' );
	}
