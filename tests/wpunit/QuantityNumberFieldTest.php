...
/**
 * Class -QuantityNumberFieldTest.
 */
class QuantityNumberFieldTest extends FormFieldTestCase implements FormFieldTestCaseInterface {
	...
	public function field_value() {
		return (string) $this->property_helper->dummy->number( 2, 5 );
	}
	...
	public function updated_field_value() {
		return (string) $this->property_helper->dummy->number( 6, 9 );
	}
