<?php  //[STAMP] 037ff0d455f775cecaf885e65a048f3f
...
trait WpunitTesterActionsActions
{
	 ...
	 * @param array $args .
	 * @return array
     * @see \Helper\Wpunit::getTextFieldDefaultArgs()
     */
    public function getTextFieldDefaultArgs(array $args = []): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getTextFieldDefaultArgs', func_get_args()));
    }
	 ...
	 * @param array $args .
	 * @return array
     * @see \Helper\Wpunit::getTextAreaFieldDefaultArgs()
     */
    public function getTextAreaFieldDefaultArgs(array $args = []): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getTextAreaFieldDefaultArgs', func_get_args()));
    }
	 ...
	 * @param array $args .
	 * @return array
     * @see \Helper\Wpunit::getAddressFieldDefaultArgs()
     */
    public function getAddressFieldDefaultArgs(array $args = []): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getAddressFieldDefaultArgs', func_get_args()));
    }
	 ...
	 * @param array $args .
	 * @return array
     * @see \Helper\Wpunit::getCaptchaFieldDefaultArgs()
     */
    public function getCaptchaFieldDefaultArgs(array $args = []): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCaptchaFieldDefaultArgs', func_get_args()));
    }
	 ...
	 * @param array $args .
	 * @return array
     * @see \Helper\Wpunit::getChainedSelectFieldDefaultArgs()
     */
    public function getChainedSelectFieldDefaultArgs(array $args = []): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getChainedSelectFieldDefaultArgs', func_get_args()));
    }
