<?php  //[STAMP] d5e5c900648372a906cd2e3417bb7a4a
...
trait WpunitTesterActionsActions
{
	 ...
	 * @param array $args .
	 * @return array
     * @see \Helper\Wpunit::getCheckboxDefaultArgs()
     */
    public function getCheckboxDefaultArgs(array $args = []): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCheckboxDefaultArgs', func_get_args()));
    }
