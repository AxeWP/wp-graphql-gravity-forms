<?php  //[STAMP] 3ba0d8edcb7580157f2b2750fe20f341
...
trait WpunitTesterActionsActions
{
     ...
     *
     * Get the default args for a PostContent field.
     * @see \Helper\Wpunit::getPostCategoryFieldArgs()
     */
    public function getPostCategoryFieldArgs(): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getPostCategoryFieldArgs', func_get_args()));
    }
     ...
     *
     * Get the default args for a PostContent field.
     * @see \Helper\Wpunit::getPostTagsFieldArgs()
     */
    public function getPostTagsFieldArgs(): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getPostTagsFieldArgs', func_get_args()));
    }
